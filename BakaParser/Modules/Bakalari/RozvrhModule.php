...
class RozvrhModule extends \BakaParser\Modules\BaseModule {
    ...
    public function getParameters($request = null) {
        ...
        if (!empty($request[0]['arg'])) {
            $options = array(
                1 => "rozvrh na tento týden",
                2 => "rozvrh na příští týden",
                3 => "stálý rozvrh" //TODO: IMPLEMENT CALENDAR
            );

            $optional['ctl00$cphmain$radiorozvrh'] = $options[$request[0]['arg']];
        }
